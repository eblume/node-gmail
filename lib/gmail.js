...
//  'boxid_gt': The message's box ID must be greater than this number.
//
...
//  boxid: The IMAP "UID" of the mail, which is specific to the mailbox.
...
var make_search = function(query) {
  ...
  for (var key in query) {
    ...
    } else if (key == "boxid_gt") {
      res = ['UID',(query.boxid_gt + 1) + ":"];
    } else {
